(function (jtd, undefined) {
    ...
    function initNavBar() {
      return fetch("https://imalightbulb.github.io/dendron-test-1/nav.html").then(function (response) {
    ...
    function initSearch() {
      ...
      request.open("GET", "https://imalightbulb.github.io/dendron-test-1/assets/js/search-data.json", true);
    ...
    jtd.setTheme = function (theme) {
      ...
      cssFile.setAttribute(
        "href",
        'https://imalightbulb.github.io/dendron-test-1/assets/css/just-the-docs-' + theme + ".css"
      );
    };

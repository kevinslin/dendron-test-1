...
describe("SnapshotPodExport", () => {
    ...
    test("with custom", async () => {
        ...
        const snapshotDir = common_test_utils_1.filterDotFiles(fs_extra_1.default.readdirSync(snapshotDirPath));
        ...
        const snapshotVault = common_test_utils_1.filterDotFiles(fs_extra_1.default.readdirSync(vaultPath));
...
describe("SnapshotPodImport", () => {
    ...
    test("don't write git", async () => {
        ...
        const vaultDir = common_test_utils_1.filterDotFiles(fs_extra_1.default.readdirSync(vaults[0]));

...
function file2Schema(fpath, wsRoot) {
...
function string2Schema({ vault, content, fname, wsRoot, }) {
    const schemaOpts = js_yaml_1.default.safeLoad(content, {
        schema: js_yaml_1.default.JSON_SCHEMA,
    });
    return parser_1.SchemaParserV2.parseRaw(schemaOpts, { root: vault, fname, wsRoot });
}

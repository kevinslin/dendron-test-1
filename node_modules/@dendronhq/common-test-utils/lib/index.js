...
exports.NoteTestPresetsV2 = exports.NoteTestUtilsV3 = exports.NodeTestPresetsV2 = exports.NodeTestUtilsV2 = exports.EngineTestUtilsV2 = exports.EngineTestUtilsV3 = exports.EngineTestUtilsV4 = exports.getLogFilePath = exports.filterDotFiles = exports.sinon = void 0;
...
function getLogFilePath(name) {
    ...
    const rootDir = path_1.default.dirname(path_1.default.dirname(path_1.default.dirname(__dirname)));
    return path_1.default.join(rootDir, "logs", `${name}.log`);
}

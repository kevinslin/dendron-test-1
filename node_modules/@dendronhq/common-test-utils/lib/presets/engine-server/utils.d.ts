...
export declare const ENGINE_HOOKS: {
    setupBasic: PreSetupHookFunction<any>;
    setupSchemaPreseet: PreSetupHookFunction<any>;
    setupSchemaPresetWithNamespaceTemplate: PreSetupHookFunction<any>;
    setupNoteRefRecursive: PreSetupHookFunction<any>;
    setupJournals: PreSetupHookFunction<any>;
};
export declare const ENGINE_HOOKS_MULTI: {
    setupBasicMulti: PreSetupHookFunction<any>;
    setupSchemaPresetWithNamespaceTemplateMulti: PreSetupHookFunction<any>;
};

 ...
 *     - bar
 */
exports.setupBasic = async ({ vaults, wsRoot, extra, }) => {
...
exports.setupJournals = async ({ vaults, wsRoot, }) => {
    const vault = vaults[0];
    const names = [
        "daily",
        "daily.journal",
    ...
    return Promise.all(names.map((fname) => {
        return noteUtils_1.NoteTestUtilsV4.createNote({
            wsRoot,
            vault,
            fname,
        });
...
exports.setupNoteRefRecursive = async ({ vaults, wsRoot, extra, }) => {
    const vault = vaults[0];
    // TODO: HACK
    let props;
    if (extra === null || extra === void 0 ? void 0 : extra.idv2) {

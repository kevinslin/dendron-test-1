...
exports.RemarkUtils = exports.LinkUtils = exports.getNoteOrError = exports.addError = exports.ALIAS_DIVIDER = void 0;
...
class RemarkUtils {
    static h1ToTitle(note, changes) {
        return function () {
            return (tree, _vfile) => {
                let root = tree;
                const idx = lodash_1.default.findIndex(root.children, (ent) => ent.type === "heading" && ent.depth === 1);
                if (idx >= 0) {

...
describe("markdown pod", async () => {
    ...
    beforeEach(async function () {
        ...
        vault = { fsPath: common_server_1.tmpDir().name };
        await common_test_utils_1.NodeTestUtilsV2.createNotes({ vaultPath: vault.fsPath });
    ...
    test("config present, default", async () => {
        ...
        const vpath = common_server_1.vault2Path({ wsRoot, vault });
        let [expectedFiles, actualFiles] = common_test_utils_1.FileTestUtils.cmpFiles(vpath, [
            "assets",
            "project.p1.md",
            "project.p1.n1.md",
            "project.p1.n2.md",
        ...
        const assetsDir = fs_extra_1.default.readdirSync(path_1.default.join(vault.fsPath, "assets"));
        expect(assetsDir.length).toEqual(2);
        const fileBody = fs_extra_1.default.readFileSync(path_1.default.join(vault.fsPath, "project.p1.md"), {
            encoding: "utf8",
        });
